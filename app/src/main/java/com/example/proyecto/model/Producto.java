...
public class Producto {
    String Nombre_pro,Tipo_pro, Cantidad_pro,Precio_pro, Photo ;

    public Producto(){

    }

    public Producto(String nombre_pro, String tipo_pro, String cantidad_pro, String precio_pro, String photo) {
